...
common_messages = {
    ...
    'hello': 'Здравствуйте! Вас привестсвует помощник по подбору спортивных товаров FitTorg! Если Вам не понятно, как использовать'
             'меня, нажмите /help. Перед запуском бота необходима регистрация. Осуществить регистрацию можно с помощью команды /registrate.'
             'Для выбора товаров нажмите /choice.',
    'help': '...',
}
